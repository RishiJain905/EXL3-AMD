...
python run.py speed -m "MODEL_DIRECTORY" --cache-type q8 --spec-type draft-mtp --spec-draft-n-max 4 -c 4096 --execute
python run.py speed -m "MODEL_DIRECTORY" --cache-type q8 --spec-type draft-mtp --spec-draft-n-max 6 --draft-confidence 0.6 -c 4096 --execute
```
